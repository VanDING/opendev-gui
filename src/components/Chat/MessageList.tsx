...
export function MessageList() {
  ...
  return (
    <div ref={scrollContainerRef} className="flex-1 overflow-y-auto bg-surface-elevated" onScroll={handleScroll}>
      <div className="max-w-5xl mx-auto py-6 px-4 md:px-8 space-y-4">
        ...
        {userHasScrolled && (
          <Button
            ...
            className="fixed bottom-24 left-1/2 -translate-x-1/2 z-10 rounded-full shadow-popover animate-slide-up"
          >
            ↓ New messages
          </Button>
        )}
